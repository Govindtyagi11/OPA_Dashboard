...
const JobLoginPage = () => {
  ...
  return (
    <div className="course_login job_login">
      ...
      <div className="form">
        <div className="form_content">
          ...
          <div className="login_btn">
            <a href="/job-landing-page">
              <button>Login as a Job Seeker</button>
            </a>
          </div>
          <div className="create_btn">
            <Link to="/recruiter-login">
              <button>Login as a Recruiter</button>
            </Link>
          </div>
          <div></div>
        </div>
